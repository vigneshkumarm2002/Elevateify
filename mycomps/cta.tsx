          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <button
                ...
                className="rounded-full bg-white px-6 py-3 cursor-pointer text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white flex items-center gap-2 transition-all hover:scale-105"
              >
                START PROJECT
